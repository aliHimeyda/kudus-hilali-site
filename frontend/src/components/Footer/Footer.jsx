        ...
        <div className="footerflex d-flex flex-md-row flex-column gap-4">
          ...
          <div className="d-flex flex-column align-items-center justify-content-center">
            ...
            <ul className="list-unstyled small">
              <li><img src="/assets/EmailVector.svg" alt="" /> <a href="mailto:kudushilali@gmail.com">kudushilali@gmail.com</a></li>
              <li><img src="/assets/CallVector.svg" alt="" /> +90 505 878 50 40</li>
              <li><img src="/assets/LocationVector.svg" alt="" /> Arabacıalanı, 605 nolu sokak<br />No: 1/1, 54100 Serdivan/Sakarya</li>
            </ul>
