    ...
    <>
      ...
      <div className="container-fluid p-0">
        <div className="hero-section position-relative text-center">
          <img loading="eager" src="/assets/2000.webp" alt="Hero" />
          ...
          <div className="container d-flex flex-column gap-3 p-5 mt-0">
            ...
            <div className="w-100 d-flex flex-md-row flex-column gap-5 ">
              <h2 className="fw-bold " style={{ fontSize: "33px" }}>
                We are a humanitarian organization dedicated to serving the
                people of Gaza and beyond.
              </h2>
              ...
              <p className="text-muted " style={{ fontSize: "15px" }}>
                ...
                displacement. <br /> Our efforts are rooted in compassion,
                social development, and mutual support as we strive to restore
                dignity, hope, and opportunity where it’s needed most.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="d-flex flex-column">
                <div className="value-card p-3">
                  ...
                  <p className="text-muted" style={{ fontSize: "13px" }}>
                    ...
                    communities to recover, rebuild, and thrive through and
                    after crises.
                  </p>
                </div>
              </div>
