...
const { t ,i18n} = useTranslation();
  ...
  useEffect(() => {
    const t = setTimeout(() => setEarthanimation(true), 2000);
    return () => clearTimeout(t);
  }, []);
  useEffect(() => {
  ...
  <>
    ...
    <div className="contactuspage">
      <div className="earthcontainer d-flex justify-content-center align-items-center position-relative">
        ...
        />
        <div className={`${earthanimation ? "section-banner" : ""}`}>
          <div id="star-1">
            ...
            <div className="mt-5 d-flex flex-column gap-4">
              <div className="d-flex flex-row gap-3">
                ...
                <button className="button" data-text="Awesome">
                  <span className="actual-text text-start">
                    info@kudushilali.org
                  </span>
                  <span aria-hidden="true" className="hover-text text-start">
                    info@kudushilali.org
                  </span>
                </button>
              </div>
              ...
              <div className="d-flex flex-row gap-3">
                ...
                />
                <button className="button" data-text="Awesome">
                  <span className="actual-text text-start">+90 505 878 50 40</span>
                  <span aria-hidden="true" className="hover-text text-start">
                    +90 505 878 50 40
                  </span>
                </button>
